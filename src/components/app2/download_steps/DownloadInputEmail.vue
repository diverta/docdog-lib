      ...
      <div class="kuroco-modal__body__section">
        <form @submit.prevent>
          <div class="kuroco-form__item">
            <div
              :class="[
                { 'kuroco-form__item--error': email_valid === false },
                { 'kuroco-form__item--success': email_valid === true },
              ]"
            >
              <input
                name="email"
