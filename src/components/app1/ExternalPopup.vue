<template>
  <div class="kuroco kuroco--toggle--open">
    <button
      type="button"
      v-if="!isLogin"
      class="kuroco-button--floating"
      @click="redirect({ target: 'SignIn' })"
    ...
    >
      <div class="kuroco-tooltip__outer">
        ...
        <span class="kuroco-tooltip">ログイン</span>
      </div>
    </button>
    <button
      type="button"
    ...
    >
      <div class="kuroco-tooltip__outer">
        ...
        <span class="kuroco-tooltip">マイページ</span>
      </div>
    </button>
  </div>
</template>
